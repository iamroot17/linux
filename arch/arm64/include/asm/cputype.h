...
#define MPIDR_LEVEL_BITS	(1 << MPIDR_LEVEL_BITS_SHIFT) // 8
#define MPIDR_LEVEL_MASK	((1 << MPIDR_LEVEL_BITS) - 1) // 0xFF

#define MPIDR_LEVEL_SHIFT(level) \
	(((1 << level) >> 1) << MPIDR_LEVEL_BITS_SHIFT)
// MPIDR_LEVEL_SHIFT(0) = 0
// MPIDR_LEVEL_SHIFT(1) = 8
// MPIDR_LEVEL_SHIFT(2) = 16
// MPIDR_LEVEL_SHIFT(3) = 32
